...
/// The animation builder of [MslideShareDialog].
class MslideShareDialogAnimatedBuilder extends StatelessWidget {
  const MslideShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          MslideShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  MslideShareDialogEnterAnimation animation,
);

class MslideShareDialogEnterAnimation {
  MslideShareDialogEnterAnimation(this.controller)
