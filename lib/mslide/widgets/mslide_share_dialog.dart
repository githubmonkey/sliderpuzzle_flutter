...
/// {@template mslide_share_dialog}
/// Displays a mslide share dialog with a score of the completed puzzle
/// and an option to share the score using Twitter or Facebook.
/// {@endtemplate}
class MslideShareDialog extends StatefulWidget {
  /// {@macro mslide_share_dialog}
  const MslideShareDialog({
    Key? key,
  ...
  @override
  State<MslideShareDialog> createState() => _MslideShareDialogState();
}

class _MslideShareDialogState extends State<MslideShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('mslide_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('mslide_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('mslide_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: MslideShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('mslide_share_dialog_close_button'),
