...
/// {@template mslide_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class MslideTwitterButton extends StatelessWidget {
  /// {@macro mslide_twitter_button}
  const MslideTwitterButton({Key? key}) : super(key: key);
...
/// {@template mslide_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class MslideFacebookButton extends StatelessWidget {
  /// {@macro mslide_facebook_button}
  const MslideFacebookButton({Key? key}) : super(key: key);
...
/// {@template mslide_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class MslideShareButton extends StatefulWidget {
  /// {@macro mslide_share_button}
  const MslideShareButton({
    Key? key,
  ...
  @override
  State<MslideShareButton> createState() => _MslideShareButtonState();
}

class _MslideShareButtonState extends State<MslideShareButton> {
