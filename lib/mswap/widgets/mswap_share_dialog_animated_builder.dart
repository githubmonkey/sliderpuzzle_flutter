...
/// The animation builder of [MswapShareDialog].
class MswapShareDialogAnimatedBuilder extends StatelessWidget {
  const MswapShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          MswapShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  MswapShareDialogEnterAnimation animation,
);

class MswapShareDialogEnterAnimation {
  MswapShareDialogEnterAnimation(this.controller)
