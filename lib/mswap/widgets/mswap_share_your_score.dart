...
/// {@template mswap_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class MswapShareYourScore extends StatelessWidget {
  /// {@macro mswap_share_your_score}
  const MswapShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final MswapShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('mswap_share_your_score'),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      key: const Key('mswap_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        key: const Key('mswap_share_your_score_message'),
                        textAlign: textAlign,
